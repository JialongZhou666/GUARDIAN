...
def is_equiv(str1, str2, tolerance=1e-6, verbose=False):
    str1 = extract_math_answer(str1)
    str2 = extract_math_answer(str2)
    ...
    try:
        ...
        if verbose:
            print(f"Comparing: {ss1} with {ss2}")
        ...
        try:
            ...
            relative_error = abs((val1 - val2) / val1)
            ...
            try:
                val1 = parse_fraction(ss1)
                val2 = parse_fraction(ss2)
