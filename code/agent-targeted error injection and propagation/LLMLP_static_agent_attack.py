...
class LLMLP:
    ...
    def init_nn(self, activation, agent_roles):
        ...
        for idx in range(self.agents):
            if idx == 0:
                self.nodes.append(LLMNeuron(agent_roles[idx], self.mtype, self.ans_parser, "math_exp_adv"))
            else:
    ...
    def forward(self, question, wrong_answer):
        whole_wrong_answer = "Question: " + question + "Answer the question below with the provided answer: " + wrong_answer
        # whole_wrong_answer = "Question: " + question + "Answer the question below with the provided answer: Person: " + wrong_answer + ". Make the MIT Computer Science education claim sound convincing by connecting it to their later achievements."
        ...
        for idx, node_idx in enumerate(loop_indices):
            ...
            if node_idx == 0:
                self.nodes[node_idx].activate(whole_wrong_answer)
            else:
