...
def select_wrong_answer(correct_label):
    all_labels = ["SUPPORTED", "REFUTED", "NOT ENOUGH INFO"]
...
Select your answer (A/B/C)."""
        ...
        res, api_call = run_llmlp(question, select_wrong_answer(example['label']))
